...
public class BufferPool {
     ...
     *
     */
    private void evictPages(int[] refbits) {
        ...
        for (Map.Entry<PageID, Page> entry : pool.entrySet()) {
            ...
            if(refbits[pointer] == 1){
                ...
                //System.out.println("Page removed: " + page.getPageID().getPageNo());
                //flushPage(page);
                break;
            }
            ...
            //System.out.print(" page id: " + page.getPageID().getPageNo());
            //pool.remove(page.getPageID());
